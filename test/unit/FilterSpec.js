define([
  ...
  describe('#Filter', function () {
    ...
    it('Should be defined', mocks.inject(['Filter',
      function (Filter) {
    ...
    describe('#Filter.init', function () {
      ...
      it('Should be called', mocks.inject(['Filter',
        function (Filter) {
      ...
      it('Should set new id if not provided', mocks.inject(['Filter',
        function (Filter) {
      ...
      it('Should call localStorageService if filterId is provided', mocks.inject(['Filter', 'localStorageService',
      ...
      it('Should set options to what localStorageService returns', mocks.inject(['Filter',
        function (Filter) {
    ...
    describe('setter', function () {
      ...
      beforeEach(mocks.inject(['Filter',
        function (Filter) {
          window.localStorage.setItem('ls.filter-filterId', JSON.stringify(filterOptions));
    ...
    describe('#Filter.save', function () {
      ...
      beforeEach(mocks.inject(['Filter', 'localStorageService',
        function (Filter, localStorageService) {
          window.localStorage.setItem('ls.filter-filterId', JSON.stringify(filterOptions));
          filter = new Filter('filterId');
          filterProtos = Filter.prototype;
